...
{
    public partial class AssistantObject : IUtf8JsonWriteable, IJsonModel<AssistantObject>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
