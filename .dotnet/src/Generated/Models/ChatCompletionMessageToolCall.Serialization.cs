...
{
    public partial class ChatCompletionMessageToolCall : IUtf8JsonWriteable, IJsonModel<ChatCompletionMessageToolCall>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionMessageToolCall>)this).Write(writer, new ModelReaderWriterOptions("W"));
