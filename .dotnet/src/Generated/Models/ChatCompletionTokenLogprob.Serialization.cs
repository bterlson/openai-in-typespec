...
{
    public partial class ChatCompletionTokenLogprob : IUtf8JsonWriteable, IJsonModel<ChatCompletionTokenLogprob>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionTokenLogprob>)this).Write(writer, new ModelReaderWriterOptions("W"));
