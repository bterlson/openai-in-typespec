...
{
    public partial class ChatCompletionTool : IUtf8JsonWriteable, IJsonModel<ChatCompletionTool>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionTool>)this).Write(writer, new ModelReaderWriterOptions("W"));
