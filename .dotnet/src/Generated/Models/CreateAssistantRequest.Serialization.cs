...
{
    public partial class CreateAssistantRequest : IUtf8JsonWriteable, IJsonModel<CreateAssistantRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateAssistantRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CreateAssistantRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateAssistantRequest)} does not support '{format}' format.");
            }
        ...
        internal static CreateAssistantRequest DeserializeCreateAssistantRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CreateAssistantRequest(model, name.Value, description.Value, instructions.Value, OptionalProperty.ToList(tools), OptionalProperty.ToList(fileIds), OptionalProperty.ToDictionary(metadata), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CreateAssistantRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateAssistantRequest)} does not support '{options.Format}' format.");
            }
        }
