...
{
    public partial class CreateChatCompletionRequestResponseFormat : IUtf8JsonWriteable, IJsonModel<CreateChatCompletionRequestResponseFormat>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateChatCompletionRequestResponseFormat>)this).Write(writer, new ModelReaderWriterOptions("W"));
