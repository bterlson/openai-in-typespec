...
{
    public partial class CreateChatCompletionResponseChoiceLogprobs : IUtf8JsonWriteable, IJsonModel<CreateChatCompletionResponseChoiceLogprobs>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateChatCompletionResponseChoiceLogprobs>)this).Write(writer, new ModelReaderWriterOptions("W"));
