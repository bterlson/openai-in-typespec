...
{
    public partial class CreateMessageRequest : IUtf8JsonWriteable, IJsonModel<CreateMessageRequest>
    {
        ...
        internal static CreateMessageRequest DeserializeCreateMessageRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CreateMessageRequest(role, content, OptionalProperty.ToList(fileIds), OptionalProperty.ToDictionary(metadata), serializedAdditionalRawData);
        }
