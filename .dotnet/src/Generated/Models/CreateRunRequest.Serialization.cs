...
{
    public partial class CreateRunRequest : IUtf8JsonWriteable, IJsonModel<CreateRunRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateRunRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CreateRunRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateRunRequest)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateRunRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateRunRequest)} does not support '{options.Format}' format.");
            }
        }
