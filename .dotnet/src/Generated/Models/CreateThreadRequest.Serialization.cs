...
{
    public partial class CreateThreadRequest : IUtf8JsonWriteable, IJsonModel<CreateThreadRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateThreadRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CreateThreadRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateThreadRequest)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateThreadRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateThreadRequest)} does not support '{options.Format}' format.");
            }
        }
