...
{
    public partial class DeleteThreadResponse : IUtf8JsonWriteable, IJsonModel<DeleteThreadResponse>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeleteThreadResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
