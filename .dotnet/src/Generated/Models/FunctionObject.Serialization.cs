...
{
    public partial class FunctionObject : IUtf8JsonWriteable, IJsonModel<FunctionObject>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
