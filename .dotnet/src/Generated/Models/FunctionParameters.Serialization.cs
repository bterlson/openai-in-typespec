...
{
    public partial class FunctionParameters : IUtf8JsonWriteable, IJsonModel<FunctionParameters>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
