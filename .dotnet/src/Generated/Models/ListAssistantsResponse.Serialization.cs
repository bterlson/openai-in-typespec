...
{
    public partial class ListAssistantsResponse : IUtf8JsonWriteable, IJsonModel<ListAssistantsResponse>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListAssistantsResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ListAssistantsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListAssistantsResponse)} does not support '{format}' format.");
            }
        ...
        internal static ListAssistantsResponse DeserializeListAssistantsResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("data"u8))
                {
                    ...
                    {
                        array.Add(AssistantObject.DeserializeAssistantObject(item));
                    }
                    data = array;
                    continue;
                }
            ...
            return new ListAssistantsResponse(@object, data, firstId, lastId, hasMore, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ListAssistantsResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListAssistantsResponse)} does not support '{options.Format}' format.");
            }
        }
