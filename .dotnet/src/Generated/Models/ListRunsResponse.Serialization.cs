...
{
    public partial class ListRunsResponse : IUtf8JsonWriteable, IJsonModel<ListRunsResponse>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListRunsResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
