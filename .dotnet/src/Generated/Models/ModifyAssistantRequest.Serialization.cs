...
{
    public partial class ModifyAssistantRequest : IUtf8JsonWriteable, IJsonModel<ModifyAssistantRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModifyAssistantRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
