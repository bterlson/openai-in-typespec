...
{
    public partial class ModifyRunRequest : IUtf8JsonWriteable, IJsonModel<ModifyRunRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModifyRunRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
