...
{
    public partial class RunCompletionUsage : IUtf8JsonWriteable, IJsonModel<RunCompletionUsage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunCompletionUsage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RunCompletionUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunCompletionUsage)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RunCompletionUsage>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RunCompletionUsage)} does not support '{options.Format}' format.");
            }
        }
