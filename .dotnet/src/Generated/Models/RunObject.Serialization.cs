...
{
    public partial class RunObject : IUtf8JsonWriteable, IJsonModel<RunObject>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
