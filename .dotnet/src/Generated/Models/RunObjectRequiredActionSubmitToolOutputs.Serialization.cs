...
{
    public partial class RunObjectRequiredActionSubmitToolOutputs : IUtf8JsonWriteable, IJsonModel<RunObjectRequiredActionSubmitToolOutputs>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunObjectRequiredActionSubmitToolOutputs>)this).Write(writer, new ModelReaderWriterOptions("W"));
