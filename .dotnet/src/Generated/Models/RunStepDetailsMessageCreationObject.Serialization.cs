...
{
    internal partial class RunStepDetailsMessageCreationObject : IUtf8JsonWriteable, IJsonModel<RunStepDetailsMessageCreationObject>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepDetailsMessageCreationObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
