...
{
    internal partial class RunStepDetailsMessageCreationObjectMessageCreation : IUtf8JsonWriteable, IJsonModel<RunStepDetailsMessageCreationObjectMessageCreation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepDetailsMessageCreationObjectMessageCreation>)this).Write(writer, new ModelReaderWriterOptions("W"));
