...
{
    public partial class RunStepObject : IUtf8JsonWriteable, IJsonModel<RunStepObject>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
