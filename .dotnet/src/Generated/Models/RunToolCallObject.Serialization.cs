...
{
    public partial class RunToolCallObject : IUtf8JsonWriteable, IJsonModel<RunToolCallObject>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunToolCallObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
