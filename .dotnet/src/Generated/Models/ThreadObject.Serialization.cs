...
{
    public partial class ThreadObject : IUtf8JsonWriteable, IJsonModel<ThreadObject>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreadObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
