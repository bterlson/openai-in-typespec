...
internal partial class MultipartContent : BinaryContent
{
    ...
    private static void ValidateBoundary(string boundary)
    {
        ...
        if (string.IsNullOrWhiteSpace(boundary)) throw new ArgumentException(nameof(boundary));
    ...
    public void ApplyToRequest(PipelineRequest request)
    {
        request.Headers.Set("content-type", $"multipart/{_subtype}; boundary={_boundary}");
    ...
    public override void WriteTo(Stream stream, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            for (int contentIndex = 0; contentIndex < _nestedContent.Count; contentIndex++)
            {
                ...
                BinaryContent content = _nestedContent[contentIndex].RequestContent;
    ...
    {
        public readonly BinaryContent RequestContent;
        public Dictionary<string, string> Headers;

        public MultipartRequestContent(BinaryContent content, Dictionary<string, string> headers)
        {
